...
## Corpus Check
- 52 files · ~18,521 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 626 nodes · 1294 edges · 52 communities (44 shown, 8 thin omitted)
- Extraction: 62% EXTRACTED · 38% INFERRED · 0% AMBIGUOUS · INFERRED: 493 edges (avg confidence: 0.51)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `daad8209`
...
Cohesion: 0.18
Nodes (13): Change Workflow, Collaboration Platform, Definition of Done, Engineering Guidance, Git Conventions, graphify, Graphify query and refresh workflow, OpenSpec change workflow (+5 more)
...
Cohesion: 0.20
Nodes (11): Repository governance proposal, Repository governance capability, Local validation suite, Archived repository governance requirements, Automated pull request quality requirement, Protected main workflow requirement, Tracked agent knowledge assets requirement, OpenSpec strict validation (+3 more)
...
Cohesion: 0.11
Nodes (44): Any, AwsBatchSubmitter, test_permanent_failures_are_not_retryable(), test_retryable_failures_select_the_worker_mode(), DynamoJobRepository, RecordingBatchSubmitter, AwsBatchSubmitter, DynamoJobRepository (+36 more)
...
Cohesion: 0.14
Nodes (44): BaseModel, FastAPI, LookupError, ContractModel, PageManifest, RedactionRegion, RegionSource, save_manifest() (+36 more)
...
Cohesion: 0.21
Nodes (14): make_job(), test_expiry_is_exact_at_the_deadline(), test_invalid_transition_is_rejected(), test_normal_transitions_increment_version(), test_only_expired_jobs_can_transition_to_expired(), test_processing_can_fail(), test_retry_transition_clears_failure_code(), test_submission_token_is_stable_for_the_transition_version() (+6 more)
...
Cohesion: 0.18
Nodes (11): ADR 0001: Documentation and GitHub governance, Apache License 2.0, Reproducible governance controls before application code, Solo-maintainer merge policy, Append-only decision history, Architecture decision record index, Decision trade-off structure, MADR template (+3 more)
...
Cohesion: 0.22
Nodes (8): Architecture and documentation alignment, Architecture decisions, Change lifecycle, Development workflow, Documentation requirements, Install tooling, Local validation, Prerequisites
...
Cohesion: 0.47
Nodes (6): Completed governance bootstrap tasks, Published documentation requirement, GitHub Pages deployment, GitHub Pages workflow, Pages workflow, Strict MkDocs build
...
Cohesion: 0.50
Nodes (4): Versioned Graphify output, Pull request definition of done, Graphify refresh check, Pull request checklist

### Community 50 - "Community 50"
Cohesion: 0.47
Nodes (8): manifest(), region(), test_manifest_requires_automatic_suggestions_on_the_same_page(), test_manifest_requires_aware_last_save_timestamp(), test_region_rejects_geometry_outside_page_bounds(), test_region_rejects_invalid_values(), test_region_serializes_normalized_geometry(), test_save_manifest_preserves_suggestions_and_increments_version()
...
## Knowledge Gaps
- **245 isolated node(s):** `Summary`, `OpenSpec`, `Validation`, `Documentation and architecture`, `Security and privacy` (+240 more)
